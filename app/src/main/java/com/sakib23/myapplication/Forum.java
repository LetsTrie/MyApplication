...
public class Forum extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setCheckedItem(R.id.forumID);

        // ****************

        btn = findViewById(R.id.CreateArticleID);
        btn.setText("Ask A Question");
        recyclerView = findViewById(R.id.RecyclerViewID);
        userPostInfoDatabase = FirebaseDatabase.getInstance().getReference("userQuestionCollection");
        info = new ArrayList<>();
        ...
        userPostInfoDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                myadapter = new AdapterRecyclerViewClass(Forum.this, info, "Forum");
        ...
        CreateNewArticleButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Forum.this, forum_question.class);
                ...
                intent.putExtra("vis", "From Forum");
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        if (menuItem.getItemId()==R.id.myProfileID) {
            finish();
            Intent intent = new Intent(Forum.this,MyProfile.class );
            startActivity(intent);
        }

        if (menuItem.getItemId()==R.id.homepageID) {
            finish();
            Intent intent = new Intent(Forum.this,Homepage.class );
            startActivity(intent);
        }
